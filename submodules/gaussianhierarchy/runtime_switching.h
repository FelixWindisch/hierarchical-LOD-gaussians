...
public:
    ...
    static void getTsIndexedDynamic(int N, int *indices, float target_size, int *nodes, float *positions, float *scales, float vx, float vy, float vz, float x, float y, float z, float *ts, int *num_siblings, void *stream);
