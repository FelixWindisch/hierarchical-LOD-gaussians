...
import torch
from lod_slang_gaussian_rasterization.internal.alphablend_tiled_slang import render_alpha_blend_tiles_slang_raw
...
def render(viewpoint_camera, xyz_ws, opacity, scales, rotations, features_dc, features_rest, distance_mu, distance_sigma, distances, pipe, bg_color, scaling_modifier = 1.0, override_color = None, sh_degree = 1):
  ...
  active_sh = sh_degree
  sh_coeffs = torch.cat((features_dc, features_rest), dim=1)
