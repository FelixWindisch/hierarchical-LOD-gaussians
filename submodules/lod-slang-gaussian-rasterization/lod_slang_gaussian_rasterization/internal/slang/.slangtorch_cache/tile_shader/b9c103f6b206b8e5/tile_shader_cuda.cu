...
#line 19 "/data/fwindisch/hierarchical-LOD-gaussians/submodules/lod-slang-gaussian-rasterization/lod_slang_gaussian_rasterization/internal/slang/tile_shader.slang"
...
#line 52
            ...
            (out_unsorted_keys_0).store<longlong>((uint(offset_0)), (longlong((ulonglong(uint(y_0) * grid_width_0 + uint(x_0)) << int(32)) | ulonglong(unpackAnyValue4_0(packAnyValue4_0(_S8))))));
            (out_unsorted_gauss_idx_0).store<int>((uint(offset_0)), (globalIdx_0));
            int _S14 = offset_0 + int(1);
...
__global__ void __kernel__compute_tile_ranges(TensorView sorted_keys_0, TensorView out_tile_ranges_0)
{
    ...
    uint _S15 = uint(globalIdx_1);

#line 72
    uint _S16 = ((sorted_keys_0).sizes[(0U)]);
...
#line 73
    ...
    longlong _S17 = ((sorted_keys_0).load<longlong>((_S15)));

#line 76
    uint currtile_0 = uint(ulonglong(_S17) >> int(32));
...
#line 77
    ...
    else
    {
        ...
        longlong _S18 = ((sorted_keys_0).load<longlong>((uint(globalIdx_1 - int(1)))));

#line 81
        uint prevtile_0 = uint(ulonglong(_S18) >> int(32));
...
#line 88
    uint _S19 = ((sorted_keys_0).sizes[(0U)]);
...
#line 89
        (out_tile_ranges_0).store<int>((currtile_0), (1U), (int(_S20)));
