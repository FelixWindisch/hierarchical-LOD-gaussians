...
#line 234 "/data/fwindisch/hierarchical-LOD-gaussians/submodules/slang-gaussian-rasterization/slang_gaussian_rasterization/internal/slang/utils.slang"
...
#line 23 "/data/fwindisch/hierarchical-LOD-gaussians/submodules/slang-gaussian-rasterization/slang_gaussian_rasterization/internal/slang/alphablend_shader.slang"
...
#line 234
__device__ Splat_2D_AlphaBlend_0 Splat_2D_AlphaBlend_x24init_0(float3  xyz_vs_1, float3  rgb_1, float opacity_1, Matrix<float, 2, 2>  inv_cov_vs_1)
{
...
#line 243
__device__ Splat_2D_AlphaBlend_0 load_splat_alphablend_0(int g_idx_0, DiffTensorView_0 xyz_vs_2, DiffTensorView_0 inv_cov_vs_2, DiffTensorView_0 opacity_2, DiffTensorView_0 rgb_2)
{
...
#line 254
    return Splat_2D_AlphaBlend_x24init_0(read_t3_float3_0(_S6, xyz_vs_2), read_t3_float3_0(_S6, rgb_2), read_t1_float_0(_S6, opacity_2), read_t2x2_float2x2_0(_S6, inv_cov_vs_2));
}
...
#line 258 "/data/fwindisch/hierarchical-LOD-gaussians/submodules/slang-gaussian-rasterization/slang_gaussian_rasterization/internal/slang/utils.slang"
...
#line 269
    ...
    float alpha_0 = (F32_min((0.99000000953674316f), (g_0.opacity_0 * (F32_exp((-0.5f * (g_0.inv_cov_vs_0.rows[int(0)].x * _S16 * _S16 + g_0.inv_cov_vs_0.rows[int(1)].y * _S17 * _S17 + (g_0.inv_cov_vs_0.rows[int(0)].y + g_0.inv_cov_vs_0.rows[int(1)].x) * _S16 * _S17)))))));
...
#line 40 "/data/fwindisch/hierarchical-LOD-gaussians/submodules/slang-gaussian-rasterization/slang_gaussian_rasterization/internal/slang/alphablend_shader.slang"
...
{
    float _S18 = pixel_state_t_nm1_0.w;

    return make_float4 ((float3 {pixel_state_t_nm1_0.x, pixel_state_t_nm1_0.y, pixel_state_t_nm1_0.z} + float3 {gauss_rgba_t_n_1.x, gauss_rgba_t_n_1.y, gauss_rgba_t_n_1.z} * make_float3 (_S18)).x, (float3 {pixel_state_t_nm1_0.x, pixel_state_t_nm1_0.y, pixel_state_t_nm1_0.z} + float3 {gauss_rgba_t_n_1.x, gauss_rgba_t_n_1.y, gauss_rgba_t_n_1.z} * make_float3 (_S18)).y, (float3 {pixel_state_t_nm1_0.x, pixel_state_t_nm1_0.y, pixel_state_t_nm1_0.z} + float3 {gauss_rgba_t_n_1.x, gauss_rgba_t_n_1.y, gauss_rgba_t_n_1.z} * make_float3 (_S18)).z, _S18 * (1.0f - gauss_rgba_t_n_1.w));
}


#line 27
__device__ float update_contribution_0(float4  pixel_state_t_nm1_1, float4  gauss_rgba_t_n_2)
{
    return gauss_rgba_t_n_2.w * pixel_state_t_nm1_1.w;
}
...
{
    float _S19 = (*dppixel_state_t_nm1_0).primal_1.w;

    float3  s_diff_color_t_n_T_0 = float3 {_s_dOut_0.x, _s_dOut_0.y, _s_dOut_0.z};

#line 35
    float3  _S20 = float3 {(*dpgauss_rgba_t_n_0).primal_1.x, (*dpgauss_rgba_t_n_0).primal_1.y, (*dpgauss_rgba_t_n_0).primal_1.z} * s_diff_color_t_n_T_0;

#line 35
    float3  _S21 = make_float3 (_S19) * s_diff_color_t_n_T_0;

#line 35
    float _S22 = (1.0f - (*dpgauss_rgba_t_n_0).primal_1.w) * _s_dOut_0.w + _S20.x + _S20.y + _S20.z;

#line 35
    float4  _S23 = make_float4 (_S21.x, _S21.y, _S21.z, - (_S19 * _s_dOut_0.w));

#line 35
    dpgauss_rgba_t_n_0->primal_1 = (*dpgauss_rgba_t_n_0).primal_1;

#line 35
    dpgauss_rgba_t_n_0->differential_0 = _S23;

#line 35
    float4  _S24 = make_float4 (s_diff_color_t_n_T_0.x, s_diff_color_t_n_T_0.y, s_diff_color_t_n_T_0.z, _S22);

#line 35
    dppixel_state_t_nm1_0->primal_1 = (*dppixel_state_t_nm1_0).primal_1;

#line 35
    dppixel_state_t_nm1_0->differential_0 = _S24;
...
#line 33
__device__ void s_bwd_update_pixel_state_0(DiffPair_vectorx3Cfloatx2C4x3E_0 * _S25, DiffPair_vectorx3Cfloatx2C4x3E_0 * _S26, float4  _S27)
{

#line 33
    s_bwd_prop_update_pixel_state_0(_S25, _S26, _S27);
...
#line 27
__device__ void s_bwd_prop_update_contribution_0(DiffPair_vectorx3Cfloatx2C4x3E_0 * dppixel_state_t_nm1_1, DiffPair_vectorx3Cfloatx2C4x3E_0 * dpgauss_rgba_t_n_1, float _s_dOut_1)
{
    float _S28 = (*dpgauss_rgba_t_n_1).primal_1.w * _s_dOut_1;

#line 29
    float4  _S29 = make_float4 (0.0f, 0.0f, 0.0f, (*dppixel_state_t_nm1_1).primal_1.w * _s_dOut_1);

#line 29
    dpgauss_rgba_t_n_1->primal_1 = (*dpgauss_rgba_t_n_1).primal_1;

#line 29
    dpgauss_rgba_t_n_1->differential_0 = _S29;

#line 29
    float4  _S30 = make_float4 (0.0f, 0.0f, 0.0f, _S28);

#line 29
    dppixel_state_t_nm1_1->primal_1 = (*dppixel_state_t_nm1_1).primal_1;

#line 29
    dppixel_state_t_nm1_1->differential_0 = _S30;
...
#line 27
__device__ void s_bwd_update_contribution_0(DiffPair_vectorx3Cfloatx2C4x3E_0 * _S31, DiffPair_vectorx3Cfloatx2C4x3E_0 * _S32, float _S33)
{

#line 27
    s_bwd_prop_update_contribution_0(_S31, _S32, _S33);
...
#line 61
__device__ float s_primal_ctx_exp_0(float _S34)
{
...
#line 61
__device__ float s_primal_ctx_min_0(float _S35, float _S36)
{

#line 61
    return (F32_min((_S35), (_S36)));
}
...
#line 61 "/data/fwindisch/hierarchical-LOD-gaussians/submodules/slang-gaussian-rasterization/slang_gaussian_rasterization/internal/slang/utils.slang"
__device__ void s_bwd_prop_ndc2pix_0(DiffPair_float_0 * dpv_1, int S_2, float _s_dOut_2)
{
    float _S42 = float(S_2) * (0.5f * _s_dOut_2);

#line 63
    dpv_1->primal_1 = (*dpv_1).primal_1;

#line 63
    dpv_1->differential_0 = _S42;
...
#line 258
__device__ void s_bwd_prop_evaluate_splat_0(DiffPair_Splat_2D_AlphaBlend_0 * dpg_0, DiffPair_vectorx3Cfloatx2C2x3E_0 * dppix_coord_0, uint H_1, uint W_1, float4  _s_dOut_3)
{

#line 269
    float _S43 = (*dpg_0).primal_1.xyz_vs_0.x;

#line 269
    int _S44 = int(W_1);

#line 269
    float _S45 = (*dppix_coord_0).primal_1.x - s_primal_ctx_ndc2pix_0(_S43, _S44);
    float _S46 = (*dpg_0).primal_1.xyz_vs_0.y;

#line 270
    int _S47 = int(H_1);

#line 270
    float _S48 = (*dppix_coord_0).primal_1.y - s_primal_ctx_ndc2pix_0(_S46, _S47);
    float _S49 = (*dpg_0).primal_1.inv_cov_vs_0.rows[int(0)].x * _S45;
    float _S50 = (*dpg_0).primal_1.inv_cov_vs_0.rows[int(1)].y * _S48;

#line 272
    float _S51 = (*dpg_0).primal_1.inv_cov_vs_0.rows[int(0)].y + (*dpg_0).primal_1.inv_cov_vs_0.rows[int(1)].x;

#line 272
    float _S52 = _S51 * _S45;

#line 271
    float power_0 = -0.5f * (_S49 * _S45 + _S50 * _S48 + _S52 * _S48);

#line 271
    float _S53 = s_primal_ctx_exp_0(power_0);

    float _S54 = (*dpg_0).primal_1.opacity_0 * _S53;


    float3  s_diff_premult_rgb_T_0 = float3 {_s_dOut_3.x, _s_dOut_3.y, _s_dOut_3.z};

#line 274
    float3  _S55 = (*dpg_0).primal_1.rgb_0 * s_diff_premult_rgb_T_0;

#line 274
    float3  _S56 = make_float3 (s_primal_ctx_min_0(0.99000000953674316f, _S54)) * s_diff_premult_rgb_T_0;

#line 273
    float _S57 = _s_dOut_3.w + _S55.x + _S55.y + _S55.z;

#line 273
    DiffPair_float_0 _S58;

#line 273
    (&_S58)->primal_1 = 0.99000000953674316f;
...
#line 273
    s_bwd_prop_min_0(&_S58, &_S59, _S57);

#line 273
    float _S60 = (*dpg_0).primal_1.opacity_0 * _S59.differential_0;

#line 273
    float _S61 = _S53 * _S59.differential_0;

#line 273
    DiffPair_float_0 _S62;

#line 273
    (&_S62)->primal_1 = power_0;

#line 273
    (&_S62)->differential_0 = 0.0f;

#line 273
    s_bwd_prop_exp_0(&_S62, _S60);

#line 271
    float _S63 = -0.5f * _S62.differential_0;
    float _S64 = _S52 * _S63;

#line 272
    float _S65 = _S48 * _S63;

#line 272
    float _S66 = _S51 * _S65;

#line 272
    float _S67 = _S45 * _S65;

#line 272
    float _S68 = _S50 * _S63;

#line 272
    float _S69 = (*dpg_0).primal_1.inv_cov_vs_0.rows[int(1)].y * _S65;

#line 272
    float _S70 = _S48 * _S65;

#line 2059 "core.meta.slang"
    float2  _S71 = make_float2 (0.0f);
...
#line 271 "/data/fwindisch/hierarchical-LOD-gaussians/submodules/slang-gaussian-rasterization/slang_gaussian_rasterization/internal/slang/utils.slang"
    float _S73 = _S49 * _S63;

#line 271
    float _S74 = _S45 * _S63;

#line 271
    float _S75 = (*dpg_0).primal_1.inv_cov_vs_0.rows[int(0)].x * _S74;

#line 271
    float _S76 = _S45 * _S74;
...
#line 270
    s_bwd_prop_ndc2pix_0(&_S80, _S47, _S79);

#line 269
    float _S81 = _S66 + _S73 + _S75;
...
#line 269
    s_bwd_prop_ndc2pix_0(&_S83, _S44, _S82);

#line 269
    Matrix<float, 2, 2>  _S84 = makeMatrix<float, 2, 2> (0.0f);
...
#line 269
    float3  _S85 = make_float3 (_S83.differential_0, _S80.differential_0, 0.0f);

#line 269
    float2  _S86 = make_float2 (_S81, _S78);

#line 269
    dppix_coord_0->primal_1 = (*dppix_coord_0).primal_1;

#line 269
    dppix_coord_0->differential_0 = _S86;

#line 269
    Splat_2D_AlphaBlend_0 _S87 = Splat_2D_AlphaBlend_x24_syn_dzero_0();

#line 269
    (&_S87)->inv_cov_vs_0 = _S84;
...
#line 258
__device__ void s_bwd_evaluate_splat_0(DiffPair_Splat_2D_AlphaBlend_0 * _S88, DiffPair_vectorx3Cfloatx2C2x3E_0 * _S89, uint _S90, uint _S91, float4  _S92)
{

    s_bwd_prop_evaluate_splat_0(_S88, _S89, _S90, _S91, _S92);
...
#line 52
__device__ Splat_2D_AlphaBlend_0 s_primal_ctx_Splat_2D_AlphaBlend_x24init_0(float3  dpxyz_vs_0, float3  dprgb_0, float dpopacity_0, Matrix<float, 2, 2>  dpinv_cov_vs_0)
{

#line 239
    Splat_2D_AlphaBlend_0 _S97 = { dpxyz_vs_0, dprgb_0, dpopacity_0, dpinv_cov_vs_0 };
...
#line 239
__device__ Splat_2D_AlphaBlend_0 s_primal_ctx_load_splat_alphablend_0(int g_idx_1, DiffTensorView_0 xyz_vs_3, DiffTensorView_0 inv_cov_vs_3, DiffTensorView_0 opacity_3, DiffTensorView_0 rgb_3, s_bwd_prop_load_splat_alphablend_Intermediates_0 * _s_diff_ctx_0)
{
...
#line 247
    Matrix<float, 2, 2>  _S99 = makeMatrix<float, 2, 2> (0.0f);

#line 247
    _s_diff_ctx_0->_S93 = _S98;

#line 247
    _s_diff_ctx_0->_S94 = _S98;

#line 247
    _s_diff_ctx_0->_S95 = 0.0f;

#line 247
    _s_diff_ctx_0->_S96 = _S99;
...
#line 249
    uint _S100 = uint(g_idx_1);

#line 249
    float3  _S101 = s_primal_ctx_read_t3_float3_0(_S100, xyz_vs_3);

#line 249
    _s_diff_ctx_0->_S93 = _S101;

#line 249
    float3  _S102 = s_primal_ctx_read_t3_float3_0(_S100, rgb_3);
    _s_diff_ctx_0->_S94 = _S102;

#line 250
    float _S103 = s_primal_ctx_read_t1_float_0(_S100, opacity_3);
    _s_diff_ctx_0->_S95 = _S103;

#line 251
    Matrix<float, 2, 2>  _S104 = s_primal_ctx_read_t2x2_float2x2_0(_S100, inv_cov_vs_3);
    _s_diff_ctx_0->_S96 = _S104;

#line 252
    return s_primal_ctx_Splat_2D_AlphaBlend_x24init_0(_S101, _S102, _S103, _S104);
}
...
#line 234
__device__ void s_bwd_prop_Splat_2D_AlphaBlend_x24init_0(DiffPair_vectorx3Cfloatx2C3x3E_0 * dpxyz_vs_1, DiffPair_vectorx3Cfloatx2C3x3E_0 * dprgb_1, DiffPair_float_0 * dpopacity_1, DiffPair_matrixx3Cfloatx2C2x2C2x3E_0 * dpinv_cov_vs_1, Splat_2D_AlphaBlend_0 _s_dOut_4)
{
...
#line 234
    dpinv_cov_vs_1->differential_0 = _s_dOut_4.inv_cov_vs_0;

#line 234
    dpopacity_1->primal_1 = (*dpopacity_1).primal_1;

#line 234
    dpopacity_1->differential_0 = _s_dOut_4.opacity_0;

#line 234
    dprgb_1->primal_1 = (*dprgb_1).primal_1;

#line 234
    dprgb_1->differential_0 = _s_dOut_4.rgb_0;

#line 234
    dpxyz_vs_1->primal_1 = (*dpxyz_vs_1).primal_1;

#line 234
    dpxyz_vs_1->differential_0 = _s_dOut_4.xyz_vs_0;
...
__device__ void AtomicAdd_load_backward_0(AtomicAdd_0 this_3, uint3  i_3, float dOut_2)
{
    float oldVal_0;
...
#line 52 "/data/fwindisch/hierarchical-LOD-gaussians/submodules/slang-gaussian-rasterization/slang_gaussian_rasterization/internal/slang/utils.slang"
__device__ void s_bwd_prop_read_t2x2_float2x2_0(uint idx_6, DiffTensorView_0 t2x2_2, Matrix<float, 2, 2>  _s_dOut_5)
{
    uint3  _S105 = make_uint3 (idx_6, 0U, 0U);
    uint3  _S106 = make_uint3 (idx_6, 1U, 0U);
    uint3  _S107 = make_uint3 (idx_6, 0U, 1U);

#line 54
    AtomicAdd_load_backward_0(t2x2_2.diff_1, make_uint3 (idx_6, 1U, 1U), _s_dOut_5.rows[int(1)].y);

#line 54
    AtomicAdd_load_backward_0(t2x2_2.diff_1, _S107, _s_dOut_5.rows[int(1)].x);

#line 54
    AtomicAdd_load_backward_0(t2x2_2.diff_1, _S106, _s_dOut_5.rows[int(0)].y);

#line 54
    AtomicAdd_load_backward_0(t2x2_2.diff_1, _S105, _s_dOut_5.rows[int(0)].x);
...
#line 869 "diff.meta.slang"
__device__ void AtomicAdd_load_backward_1(AtomicAdd_0 this_4, uint2  i_4, float dOut_3)
{
    float oldVal_1;
...
#line 20 "/data/fwindisch/hierarchical-LOD-gaussians/submodules/slang-gaussian-rasterization/slang_gaussian_rasterization/internal/slang/utils.slang"
__device__ void s_bwd_prop_read_t1_float_0(uint idx_7, DiffTensorView_0 t1_2, float _s_dOut_6)
{
    AtomicAdd_load_backward_1(t1_2.diff_1, make_uint2 (idx_7, 0U), _s_dOut_6);
...
__device__ void s_bwd_prop_read_t3_float3_0(uint idx_8, DiffTensorView_0 t3_2, float3  _s_dOut_7)
{
    uint2  _S108 = make_uint2 (idx_8, 0U);
    uint2  _S109 = make_uint2 (idx_8, 1U);

#line 28
    AtomicAdd_load_backward_1(t3_2.diff_1, make_uint2 (idx_8, 2U), _s_dOut_7.z);

#line 28
    AtomicAdd_load_backward_1(t3_2.diff_1, _S109, _s_dOut_7.y);

#line 28
    AtomicAdd_load_backward_1(t3_2.diff_1, _S108, _s_dOut_7.x);
...
#line 243
__device__ void s_bwd_prop_load_splat_alphablend_0(int g_idx_2, DiffTensorView_0 xyz_vs_4, DiffTensorView_0 inv_cov_vs_4, DiffTensorView_0 opacity_4, DiffTensorView_0 rgb_4, Splat_2D_AlphaBlend_0 _s_dOut_8, s_bwd_prop_load_splat_alphablend_Intermediates_0 _s_diff_ctx_1)
{

#line 249
    uint _S110 = uint(g_idx_2);

#line 254
    float3  _S111 = make_float3 (0.0f);

#line 254
    DiffPair_vectorx3Cfloatx2C3x3E_0 _S112;

#line 254
    (&_S112)->primal_1 = _s_diff_ctx_1._S93;
...
#line 254
    (&_S113)->primal_1 = _s_diff_ctx_1._S94;

#line 254
    (&_S113)->differential_0 = _S111;

#line 254
    DiffPair_float_0 _S114;

#line 254
    (&_S114)->primal_1 = _s_diff_ctx_1._S95;
...
#line 254
    DiffPair_matrixx3Cfloatx2C2x2C2x3E_0 _S116;

#line 254
    (&_S116)->primal_1 = _s_diff_ctx_1._S96;

#line 254
    (&_S116)->differential_0 = _S115;

#line 254
    s_bwd_prop_Splat_2D_AlphaBlend_x24init_0(&_S112, &_S113, &_S114, &_S116, _s_dOut_8);

#line 254
    s_bwd_prop_read_t2x2_float2x2_0(_S110, inv_cov_vs_4, _S116.differential_0);

#line 254
    s_bwd_prop_read_t1_float_0(_S110, opacity_4, _S114.differential_0);

#line 254
    s_bwd_prop_read_t3_float3_0(_S110, rgb_4, _S113.differential_0);

#line 254
    s_bwd_prop_read_t3_float3_0(_S110, xyz_vs_4, _S112.differential_0);
...
#line 243
__device__ void s_bwd_load_splat_alphablend_0(int _S117, DiffTensorView_0 _S118, DiffTensorView_0 _S119, DiffTensorView_0 _S120, DiffTensorView_0 _S121, Splat_2D_AlphaBlend_0 _S122)
{


    s_bwd_prop_load_splat_alphablend_Intermediates_0 _S123;

#line 247
    Splat_2D_AlphaBlend_0 _S124 = s_primal_ctx_load_splat_alphablend_0(_S117, _S118, _S119, _S120, _S121, &_S123);

#line 247
    s_bwd_prop_load_splat_alphablend_0(_S117, _S118, _S119, _S120, _S121, _S122, _S123);
...
#line 186
                ...
                float4  gauss_rgba_0 = evaluate_splat_0((*&collected_splats_0)[j_0], _S133, H_2, W_2);
...
#line 90
                ...
                float4  gauss_rgba_1 = evaluate_splat_0((*&collected_splats_0)[j_1], _S144, H_3, W_3);
...
#line 100
                ...
                float out_0;
                *((&out_0)) = atomicAdd((contribution_1).data_ptr_at<float>(((*&collected_idx_0)[j_1])), (update_contribution_0(curr_pixel_state_1, gauss_rgba_1)));
...
#line 254
__device__ DiffPair_Splat_2D_AlphaBlend_0 s_fwd_Splat_2D_AlphaBlend_x24init_0(DiffPair_vectorx3Cfloatx2C3x3E_0 dpxyz_vs_2, DiffPair_vectorx3Cfloatx2C3x3E_0 dprgb_2, DiffPair_float_0 dpopacity_2, DiffPair_matrixx3Cfloatx2C2x2C2x3E_0 dpinv_cov_vs_2)
{
...
#line 234
__device__ DiffPair_Splat_2D_AlphaBlend_0 s_fwd_load_splat_alphablend_0(int g_idx_4, DiffTensorView_0 xyz_vs_10, DiffTensorView_0 inv_cov_vs_10, DiffTensorView_0 opacity_10, DiffTensorView_0 rgb_10)
{
...
#line 86
            FixedArray<Splat_2D_AlphaBlend_0, 64>  _S320 = *&collected_splats_0;
