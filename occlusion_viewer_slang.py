...
from gaussian_renderer import occlusion_cull, occlusion_cull_cached, render
import json
import pickle
import colorsys
import argparse
                ...
                try:
                    ...
                    if custom_cam != None:
                        ...
                        if not viewer_options["freeze_view"]:
                            ...
                            occlusion_mask = torch.ones(len(gaussians.SPT_opacity), dtype=torch.bool, device='cuda')
                        ...
                        viewpoint_cam.projection_matrix = getProjectionMatrix(znear=viewpoint_cam.znear, zfar=viewpoint_cam.zfar, fovX=viewpoint_cam.FoVx, fovY=viewpoint_cam.FoVy, primx = 0.5, primy=0.5).transpose(0,1).cuda()
